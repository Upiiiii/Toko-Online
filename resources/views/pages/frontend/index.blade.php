...
<section class="flex items-center hero">
      ...
      <div class="flex -mx-4 flex-row relative">
        ...
        @forelse ($product as $row)
            ...
            <div class="px-4 relative card group">
              ...
              <br>
              <span>{!! Str::limit($row->description, '50') !!}</span>
              <a href="{{ route('detailProduct', $row->slug) }}" class="stretched-link">
                <!-- fake children -->
              </a>
            </div>
  ...
  <section class="container mx-auto">
    <div class="flex justify-center flex-wrap">
      ...
      >
        <img src="{{ asset('frontend/images/content/logo-adobe.sv') }}g" alt="" class="mx-auto" />
      </div>
      <div
        class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
      >
      ...
      >
        <img
          src="{{ asset('frontend/images/content/logo-hermanmi') }}ller.svg"
          alt=""
          class="mx-auto"
        />
      </div>
