      ...
      <div class="flex -mx-4 flex-wrap">
        ...
        <div class="w-full md:px-4 md:w-4/12" id="shipping-detail">
          <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
            <form action="{{ route('checkout') }}" method="post" enctype="">
              @csrf
              @method('POST')
              ...
              <div class="flex flex-col mb-4">
                ...
                <div class="flex -mx-2 flex-wrap">
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="{{ url('frontend/images/content/logo-fedex.svg') }}"
                        alt="Logo Fedex"
                  ...
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="{{ url('frontend/images/content/logo-dhl.svg') }}"
                        alt="Logo dhl"
                        class="object-contain max-h-full"
                      />
                    </button>
              ...
              <div class="flex flex-col mb-4">
                ...
                <div class="flex -mx-2 flex-wrap">
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="{{ url('frontend/images/content/logo-midtrans.png') }}"
                        alt="Logo midtrans"
                        class="object-contain max-h-full"
                      />
                    </button>
